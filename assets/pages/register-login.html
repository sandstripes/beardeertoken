export function regisLogContents() {
    return `
            <center>
                ...
                <button class="rl-button=a" id="rl-t-guest"
                    onclick="guest = true;updateUlist();switchScene('main-scene', true);">Guest</button><br><br>
                ...
                <div id="rl-signup-container" class="hidden">
                    <input id="rl-username-s" autocomplete="off" placeholder="Username..." type="text"
                        maxlength=20></input><br>
                    <input id="rl-password-s" autocomplete="off" placeholder="Password..." type="password"></input><br>
                    <input id="rl-invitecode" autocomplete="off" placeholder="Invite code..." type="text"
                        maxlength=16></input><br>
                    <button class="rl-button" onclick="register();">Sign up</button><br>
                    <p>note: signup might be disabled for now</p>
                </div><br><br>
                <span>Please ensure you have read the <a
                        href="https://soktdeer.com/guidelines">GUIDELINES</a>.</span><br>
                <small><span onclick="setServerPrompt();" class="text-clickable">Set a custom server
                        URL</span></small><br>
